 ...
 */
final class Version20260409050536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate CHANGE user_id user_id BIGINT NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE education_level education_level VARCHAR(100) NOT NULL, CHANGE experience_years experience_years INT NOT NULL, CHANGE cv_path cv_path VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE event_registration ADD candidate_name VARCHAR(255) DEFAULT NULL, ADD candidate_email VARCHAR(255) DEFAULT NULL, CHANGE id id BIGINT NOT NULL, CHANGE event_id event_id BIGINT DEFAULT NULL, CHANGE candidate_id candidate_id BIGINT DEFAULT NULL, CHANGE registered_at registered_at DATETIME NOT NULL, CHANGE attendance_status attendance_status VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE event_review CHANGE id id BIGINT NOT NULL, CHANGE rating rating INT NOT NULL, CHANGE comment comment LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE recruiter CHANGE user_id user_id BIGINT NOT NULL, CHANGE company_location company_location VARCHAR(255) NOT NULL, CHANGE company_description company_description LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE recruitment_event DROP FOREIGN KEY `recruitment_event_ibfk_1`');
        $this->addSql('ALTER TABLE recruitment_event CHANGE recruiter_id recruiter_id BIGINT DEFAULT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE event_type event_type VARCHAR(255) NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE capacity capacity INT NOT NULL, CHANGE meet_link meet_link VARCHAR(255) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE users ADD forget_code VARCHAR(10) NOT NULL, ADD forget_code_expires DATETIME NOT NULL, ADD face_person_id VARCHAR(128) NOT NULL, ADD face_enabled TINYINT NOT NULL, DROP role, CHANGE id id BIGINT NOT NULL, CHANGE first_name first_name VARCHAR(100) NOT NULL, CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE phone phone VARCHAR(30) NOT NULL, CHANGE is_active is_active TINYINT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application_status_history ADD CONSTRAINT FK_48A559FE10BC6D9F FOREIGN KEY (changed_by) REFERENCES users (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE candidate CHANGE user_id user_id BIGINT DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE education_level education_level VARCHAR(100) DEFAULT NULL, CHANGE experience_years experience_years INT DEFAULT NULL, CHANGE cv_path cv_path VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE event_registration DROP candidate_name, DROP candidate_email, CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE registered_at registered_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE attendance_status attendance_status VARCHAR(255) DEFAULT NULL, CHANGE event_id event_id BIGINT NOT NULL, CHANGE candidate_id candidate_id BIGINT NOT NULL');
        ...
        $this->addSql('DROP INDEX IDX_4BDAF69471F7E88B ON event_review');
        $this->addSql('DROP INDEX IDX_4BDAF69491BD8781 ON event_review');
        $this->addSql('ALTER TABLE event_review CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE rating rating INT DEFAULT NULL, CHANGE comment comment TEXT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE recruiter CHANGE user_id user_id BIGINT DEFAULT NULL, CHANGE company_location company_location VARCHAR(255) DEFAULT NULL, CHANGE company_description company_description TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE recruitment_event DROP FOREIGN KEY FK_D1195597156BE243');
        $this->addSql('ALTER TABLE recruitment_event CHANGE description description TEXT DEFAULT NULL, CHANGE event_type event_type VARCHAR(255) DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE capacity capacity INT DEFAULT 0, CHANGE meet_link meet_link VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE recruiter_id recruiter_id BIGINT NOT NULL');
